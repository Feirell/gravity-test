...
addEventListener("DOMContentLoaded", () => {
    ...
    function setup() {
        ...
        for (let i = 0; i < numberOfNodes; i++) {
            ...
            ge.append(new GravityNode(new Vector(width / 2, height / 2).addVector(pos), 10, multiplier, pos.setLength(initialVelocity).rotate(Math.PI * 2 * detailedConfig.initialDirectionDegree.value / 360)));
        }
